...
export const onboardingSteps: OnboardingStepDef[] = [
  ...
  },
  {
    ...
    options: [
      { value: 'Очень мягко', hint: 'без перегруза и сложных связок' },
      { value: 'Обычный домашний темп', hint: 'спокойно, но с ощущением работы' },
      { value: 'Хочу чуть активнее', hint: 'если есть силы и желание подвигаться больше' },
    ],
  },
]
